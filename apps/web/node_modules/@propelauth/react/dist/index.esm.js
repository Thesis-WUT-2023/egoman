...
const AuthProvider = props => {
  ...
  const [accessTokenChangeCounter, setAccessTokenChangeCounter] = useState(0); // Create a client and register an observer that triggers when the user logs in or out
